...
export function buildNodeRings(track) {
  ...
  track.querySelectorAll(".blog__node").forEach((nodeEl) => {
    ...
    svgOuter.style.cssText = "position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);";
    ...
    svgInner.style.cssText = "position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);";
